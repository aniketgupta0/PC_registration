...
class VoxSeT(nn.Module):
    def __init__(self, model_cfg=None, num_point_features=3, voxel_size=[0.32, 0.32, 4],
                 point_cloud_range=[0, -39.68, -3, 69.12, 39.68, 1], grid_size=[0.32, 0.32, 4]):
        super().__init__()
