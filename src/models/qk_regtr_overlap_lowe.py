...
from utils.se3_torch import compute_rigid_transform, se3_transform_list, se3_inv, compute_rigid_transform_with_sinkhorn, compute_rigid_transform_with_sinkhorn_2
...
class RegTR(GenericRegModel):
    ...
    def forward(self, batch):
        ...
        # Overlap Prediction
        #####################
        src_overlap = self.overlap_predictor(src_feats_cond)
        tgt_overlap = self.overlap_predictor(tgt_feats_cond)
